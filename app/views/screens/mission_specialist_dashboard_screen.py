...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du spécialiste de mission"""
...
class MissionSpecialistDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le spécialiste de mission"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Spécialiste de mission",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au spécialiste de mission"""
        tasks = [
            {
                "title": "Planification de mission",
                "icon": "clipboard-check",
                "description": "Planification et préparation des missions",
                "status": "2 missions en préparation",
                "module": "mission_planning"
            },
            {
                "title": "Analyse de données",
                "icon": "chart-box",
                "description": "Analyse des données de mission",
                "status": "1 analyse en cours",
                "module": "data_analysis"
            },
            {
                "title": "Coordination d'équipe",
                "icon": "account-group",
                "description": "Coordination avec l'équipe de mission",
                "status": "Équipe disponible",
                "module": "team_coordination"
            },
            {
                "title": "Rapports de mission",
                "icon": "file-document",
                "description": "Gestion des rapports de mission",
                "status": "1 rapport en attente",
                "module": "mission_reports"
            }
        ]
