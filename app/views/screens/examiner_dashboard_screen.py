...
class TaskCard(MDCard):
    """Carte pour afficher une tâche de l'examinateur"""
...
class ExaminerDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour l'examinateur"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Examinateur",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques à l'examinateur"""
        tasks = [
            {
                "title": "Examens planifiés",
                "icon": "calendar-check",
                "description": "Examens à venir",
                "status": "2 examens cette semaine",
                "module": "planned_exams"
            },
            {
                ...
                "module": "skill_assessment"
            },
            {
                "title": "Certification",
                "icon": "certificate",
                "description": "Gestion des certifications",
                "status": "1 certification à valider",
                "module": "certification"
            },
            {
                "title": "Rapports d'examen",
                "icon": "file-document-edit",
                "description": "Gestion des rapports d'examen",
