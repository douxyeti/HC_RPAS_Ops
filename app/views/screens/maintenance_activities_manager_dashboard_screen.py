...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du gestionnaire des activités de maintenance"""
...
class MaintenanceActivitiesManagerDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le gestionnaire des activités de maintenance"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Gestionnaire des activités de maintenance",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
        ...
        # ScrollView et grille pour les cartes
        scroll = MDScrollView()
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au gestionnaire des activités de maintenance"""
        tasks = [
            {
                "title": "Planning maintenance",
                "icon": "calendar-clock",
                "description": "Planification des activités de maintenance",
                "status": "3 maintenances prévues",
                "module": "maintenance_planning"
            },
            {
                "title": "Équipes techniques",
                "icon": "account-group-outline",
                "description": "Gestion des équipes de maintenance",
                "status": "5 équipes actives",
                "module": "maintenance_teams"
            },
            {
                "title": "Inventaire",
                "icon": "package-variant-closed",
                "description": "Gestion des pièces et équipements",
                "status": "Stock à jour",
            ...
            },
            {
                ...
                "description": "Suivi des rapports de maintenance",
                "status": "2 rapports en attente",
                "module": "maintenance_reports"
            }
        ]
