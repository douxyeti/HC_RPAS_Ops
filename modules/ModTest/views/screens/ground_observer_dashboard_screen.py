...
class TaskCard(MDCard):
    """Carte pour afficher une tâche de l'observateur au sol"""
...
class GroundObserverDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour l'observateur au sol"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Observateur au sol",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques à l'observateur au sol"""
        tasks = [
            {
                "title": "Surveillance de la zone",
                "icon": "eye",
                "description": "Surveillance visuelle de la zone d'opération",
                "status": "Zone sécurisée",
                "module": "area_monitoring"
            },
            {
                "title": "Communications",
                "icon": "radio",
                "description": "Communications avec l'équipe de vol",
                "status": "Canal actif",
            ...
            },
            {
                "title": "Sécurité",
                "icon": "shield-check",
                "description": "Gestion de la sécurité au sol",
                "status": "Aucun incident",
                "module": "ground_safety"
            },
            {
                "title": "Rapports",
                "icon": "file-document",
                "description": "Gestion des rapports d'observation",
                "status": "À jour",
                "module": "observation_reports"
            }
        ]
