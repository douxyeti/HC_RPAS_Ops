...
class TaskCard(MDCard):
    """Carte pour afficher une tâche de l'opérateur de charge utile"""
...
class PayloadOperatorDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour l'opérateur de charge utile"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Opérateur de charge utile",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques à l'opérateur de charge utile"""
        tasks = [
            {
                "title": "Contrôle de charge",
                "icon": "remote",
                "description": "Contrôle et surveillance de la charge utile",
                "status": "Système opérationnel",
                "module": "payload_control"
            },
            {
                "title": "Données en temps réel",
                "icon": "chart-line",
                "description": "Surveillance des données en temps réel",
            ...
            },
            {
                "title": "Maintenance",
                "icon": "wrench",
                "description": "Maintenance de la charge utile",
                "status": "Aucune action requise",
                "module": "payload_maintenance"
            },
            {
                "title": "Rapports d'opération",
                "icon": "file-document",
