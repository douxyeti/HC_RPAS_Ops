...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du copilote"""
...
class CopilotDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le copilote"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au copilote"""
        tasks = [
            {
                "title": "Support de navigation",
                "icon": "navigation",
                "description": "Assistance à la navigation et planification",
                "status": "En attente",
                "module": "navigation_support"
            },
            {
                "title": "Surveillance des systèmes",
                "icon": "monitor",
                "description": "Surveillance des systèmes de l'aéronef",
                "status": "Systèmes normaux",
                "module": "systems_monitoring"
            },
            {
            ...
            },
            {
                ...
                "icon": "alert",
                "description": "Support aux procédures d'urgence",
                "status": "Aucune urgence",
