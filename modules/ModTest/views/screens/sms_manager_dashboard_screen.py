...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du responsable SGS"""
...
class SMSManagerDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le responsable SGS"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Responsable SGS",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au responsable SGS"""
        tasks = [
            {
                "title": "Gestion des risques",
                "icon": "alert",
                "description": "Évaluation et gestion des risques",
                "status": "2 évaluations en cours",
                "module": "risk_management"
            },
            {
                "title": "Rapports de sécurité",
                "icon": "file-document-alert",
                "description": "Gestion des rapports d'incidents",
                "status": "1 nouveau rapport",
            ...
            },
            {
                ...
                "status": "Prochain audit dans 15 jours",
                "module": "safety_audits"
            },
            {
                "title": "Formation sécurité",
                "icon": "account-group",
                "description": "Gestion des formations sécurité",
                "status": "3 sessions planifiées",
