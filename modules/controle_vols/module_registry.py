...
class ModuleRegistry:
    ...
    def __init__(self):
        ...
        if not ModuleRegistry._initialized:
            ...
            self.module_id = "controle_vols"
            self.manifest_data = {}
            self.screens = {}
            self._screen_instances = {}
            ModuleRegistry._initialized = True
    
    def initialize(self, firebase_service, module_id="controle_vols"):
        """
    ...
    def navigate_to_screen(self, screen_id, field_id=None, app=None, **kwargs):
        ...
        try:
            ...
            try:
                # Importer le module contenant la classe
                if screen_id in ["login", "splash", "dashboard", "specialized_dashboard"]:
                    # Écrans génériques de l'application
                    module_path = f"modules.controle_vols.views.screens.{screen_id}_screen"
                else:
                    # Écrans spécifiques au module
                    module_path = f"modules.controle_vols.views.screens.{screen_id}_screen"
