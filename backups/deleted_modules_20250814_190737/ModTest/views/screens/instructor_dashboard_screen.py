...
class TaskCard(MDCard):
    """Carte pour afficher une tâche de l'instructeur"""
...
class InstructorDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour l'instructeur"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Instructeur",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques à l'instructeur"""
        tasks = [
            {
                "title": "Sessions de formation",
                "icon": "school",
                "description": "Sessions de formation planifiées",
                "status": "2 sessions aujourd'hui",
                "module": "training_sessions"
            },
            {
                "title": "Évaluation des élèves",
                "icon": "clipboard-check",
                "description": "Évaluation des progrès des élèves",
                "status": "3 évaluations en attente",
                "module": "student_evaluations"
            },
            {
                "title": "Matériel pédagogique",
                "icon": "book-open-variant",
                "description": "Gestion du matériel de formation",
                "status": "À jour",
                "module": "training_materials"
            },
            {
                "title": "Rapports de formation",
                "icon": "file-document",
                "description": "Gestion des rapports de formation",
                "status": "2 rapports à compléter",
                "module": "training_reports"
            }
        ]
