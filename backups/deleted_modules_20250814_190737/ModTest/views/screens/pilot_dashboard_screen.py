...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du pilote"""
...
class PilotDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le pilote"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au pilote"""
        tasks = [
            {
                "title": "Vérifications pré-vol",
                "icon": "clipboard-check",
                "description": "Liste de vérification avant le vol",
                "status": "À compléter",
                "module": "preflight_checks"
            },
            {
                "title": "Contrôle de vol",
                "icon": "airplane",
                "description": "Contrôle et navigation de l'aéronef",
                "status": "En attente",
            ...
            },
            {
                ...
                "icon": "radio",
                "description": "Communications avec l'équipe",
                "status": "Canal actif",
                "module": "communications"
            },
            {
                "title": "Rapports de vol",
                "icon": "file-document",
                "description": "Gestion des rapports de vol",
                "status": "1 rapport en attente",
                "module": "flight_reports"
            }
        ]
