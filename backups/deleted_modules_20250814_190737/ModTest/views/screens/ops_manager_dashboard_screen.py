...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du responsable des opérations"""
...
class OpsManagerDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le responsable des opérations"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Responsable des opérations",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au responsable des opérations"""
        tasks = [
            {
                "title": "Planification des opérations",
                "icon": "calendar",
                "description": "Planification et coordination des opérations",
                "status": "3 opérations en cours",
                "module": "operations_planning"
            },
            {
                "title": "Gestion des équipes",
                "icon": "account-group",
                "description": "Gestion et supervision des équipes",
            ...
            },
            {
                ...
                "icon": "file-chart",
                "description": "Rapports et analyses des opérations",
            ...
            },
            {
                ...
                "icon": "alert",
                "description": "Suivi et gestion des incidents",
                "status": "Aucun incident actif",
