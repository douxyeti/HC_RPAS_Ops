...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du technicien de maintenance"""
...
class MaintenanceTechnicianDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le technicien de maintenance"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Technicien Maintenance",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au technicien de maintenance"""
        tasks = [
            {
                "title": "Inspections",
                "icon": "magnify",
                "description": "Inspections programmées et vérifications",
                "status": "2 inspections prévues",
                "module": "inspections"
            },
            {
            ...
            },
            {
                "title": "Réparations",
                "icon": "tools",
                "description": "Réparations et corrections",
                "status": "Aucune réparation en attente",
                "module": "repairs"
            },
            {
                "title": "Documentation",
                "icon": "file-document",
                "description": "Gestion des documents techniques",
                "status": "À jour",
