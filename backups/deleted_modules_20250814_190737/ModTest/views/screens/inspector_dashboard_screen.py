...
class TaskCard(MDCard):
    """Carte pour afficher une tâche de l'inspecteur"""
...
class InspectorDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour l'inspecteur"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Inspecteur",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques à l'inspecteur"""
        tasks = [
            {
                "title": "Inspections planifiées",
                "icon": "clipboard-check",
                "description": "Inspections programmées des opérations",
                "status": "2 inspections à venir",
                "module": "planned_inspections"
            },
            {
                "title": "Audits",
                "icon": "magnify",
                "description": "Audits des procédures et conformité",
                "status": "1 audit en cours",
                "module": "audits"
            },
            {
                "title": "Évaluations",
                ...
                "status": "3 évaluations à faire",
                "module": "evaluations"
            },
            {
                "title": "Rapports",
                "icon": "file-document",
                "description": "Gestion des rapports d'inspection",
                "status": "2 rapports en attente",
                "module": "inspection_reports"
            }
        ]
