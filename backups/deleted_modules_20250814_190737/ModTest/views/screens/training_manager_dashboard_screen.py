...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du gestionnaire de la formation"""
...
class TrainingManagerDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le gestionnaire de la formation"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Gestionnaire de la formation",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au gestionnaire de la formation"""
        tasks = [
            {
                "title": "Programmes de formation",
                "icon": "book-education",
                "description": "Gestion des programmes de formation",
                "status": "4 programmes actifs",
            ...
            },
            {
                ...
                "module": "training_schedule"
            },
            {
                "title": "Suivi des formateurs",
                "icon": "account-group",
                "description": "Gestion des formateurs et instructeurs",
                "status": "8 formateurs actifs",
                "module": "trainer_management"
            },
            {
                "title": "Ressources",
                "icon": "bookshelf",
