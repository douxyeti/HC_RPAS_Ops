...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du coordinateur des opérations"""
...
class OperationsCoordinatorDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le coordinateur des opérations"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Coordinateur des opérations",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au coordinateur des opérations"""
        tasks = [
            {
                "title": "Planning opérationnel",
                "icon": "calendar-clock",
                "description": "Gestion du planning des opérations",
                "status": "3 missions planifiées",
                "module": "operations_planning"
            },
            {
                "title": "Coordination équipes",
                "icon": "account-group",
                "description": "Coordination des équipes de vol",
                "status": "4 équipes actives",
                "module": "team_coordination"
            },
            {
                "title": "Suivi des missions",
                "icon": "airplane",
                "description": "Suivi des missions en cours",
                "status": "1 mission en cours",
                "module": "mission_tracking"
            },
            {
                "title": "Rapports opérationnels",
                "icon": "file-document-edit",
                "description": "Gestion des rapports d'opération",
                "status": "2 rapports à valider",
                "module": "operation_reports"
            }
        ]
