...
class TaskCard(MDCard):
    """Carte pour afficher une tâche de l'évaluateur"""
...
class EvaluatorDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour l'évaluateur"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Évaluateur",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques à l'évaluateur"""
        tasks = [
            {
                "title": "Évaluations en cours",
                "icon": "clipboard-pulse",
                "description": "Évaluations du personnel en cours",
                "status": "3 évaluations actives",
                "module": "current_evaluations"
            },
            {
            ...
            },
            {
                ...
                "icon": "file-chart",
                "description": "Gestion des rapports d'évaluation",
                "status": "2 rapports en attente",
                "module": "evaluation_reports"
            },
            {
                "title": "Planification",
                "icon": "calendar-clock",
                "description": "Planification des évaluations",
                "status": "5 évaluations à planifier",
                "module": "evaluation_planning"
            }
        ]
