...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du formateur"""
...
class TrainerDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le formateur"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au formateur"""
        tasks = [
            {
                "title": "Programmes de formation",
                "icon": "book-education",
                "description": "Gestion des programmes de formation",
                "status": "3 programmes actifs",
                "module": "training_programs"
            },
            {
                "title": "Suivi des stagiaires",
                "icon": "account-group",
                "description": "Suivi de la progression des stagiaires",
                "status": "5 stagiaires en formation",
            ...
            },
            {
                ...
                "description": "Évaluations des compétences",
                "status": "2 évaluations à faire",
                "module": "skill_evaluations"
            }
        ]
