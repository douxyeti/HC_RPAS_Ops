...
class TaskCard(MDCard):
    """Carte pour afficher une tâche de l'agent de sécurité"""
...
class SecurityAgentDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour l'agent de sécurité"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Agent de sécurité",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques à l'agent de sécurité"""
        tasks = [
            {
            ...
            },
            {
                "title": "Surveillance",
                "icon": "cctv",
                "description": "Surveillance des zones d'opération",
                "status": "Active",
                "module": "surveillance"
            },
            {
