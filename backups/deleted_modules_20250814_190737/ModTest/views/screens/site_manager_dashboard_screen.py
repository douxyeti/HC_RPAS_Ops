...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du gestionnaire de site"""
...
class SiteManagerDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le gestionnaire de site"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Gestionnaire de site",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au gestionnaire de site"""
        tasks = [
            {
            ...
            },
            {
                ...
                "status": "2 tâches en attente",
                "module": "site_maintenance"
            },
            {
                "title": "Sécurité du site",
                "icon": "shield-check",
                "description": "Contrôle de la sécurité du site",
                "status": "Niveau normal",
                "module": "site_security"
            },
            {
                "title": "Rapports de site",
                "icon": "file-chart",
                "description": "Gestion des rapports du site",
