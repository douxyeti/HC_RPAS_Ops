...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du responsable assurance de la qualité"""
...
class QualityAssuranceManagerDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le responsable assurance de la qualité"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Responsable assurance de la qualité",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au responsable assurance de la qualité"""
        tasks = [
            {
                "title": "Audits qualité",
                "icon": "clipboard-check",
                "description": "Planification et suivi des audits qualité",
                "status": "2 audits en cours",
                "module": "quality_audits"
            },
            {
                "title": "Contrôle documentaire",
                "icon": "file-document-multiple",
                "description": "Gestion de la documentation qualité",
                "status": "5 documents à réviser",
                "module": "document_control"
            },
            {
                "title": "Indicateurs qualité",
                "icon": "chart-line",
                "description": "Suivi des KPIs qualité",
                "status": "Mise à jour mensuelle",
                "module": "quality_kpis"
            },
            {
