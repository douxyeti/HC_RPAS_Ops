...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du coordinateur de formation"""
...
class TrainingCoordinatorDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le coordinateur de formation"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        ...
        # Titre
        title = MDLabel(
            text="Tableau de bord Coordinateur de formation",
            bold=True,
            font_size="24sp",
            valign="center",
            height=dp(56),
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au coordinateur de formation"""
        tasks = [
            {
                "title": "Calendrier formations",
                "icon": "calendar-month",
                "description": "Gestion du calendrier des formations",
                "status": "Planning à jour",
                "module": "training_calendar"
            },
            {
                "title": "Suivi des stagiaires",
                "icon": "account-group",
                "description": "Suivi des progrès des stagiaires",
                "status": "12 stagiaires actifs",
                "module": "trainee_tracking"
            },
            {
                "title": "Ressources pédagogiques",
                "icon": "book-open-variant",
                "description": "Gestion des ressources de formation",
                "status": "Documentation à jour",
                "module": "training_resources"
            },
            {
                "title": "Coordination formateurs",
                "icon": "account-tie",
                "description": "Coordination avec les formateurs",
                "status": "5 formateurs disponibles",
                "module": "trainer_coordination"
            }
        ]
