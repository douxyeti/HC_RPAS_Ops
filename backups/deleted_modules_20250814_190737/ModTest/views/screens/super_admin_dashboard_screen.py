...
class TaskCard(MDCard):
    """Carte pour afficher une tâche du super administrateur"""
...
class SuperAdminDashboardScreen(MDScreen):
    """Écran du tableau de bord spécialisé pour le super administrateur"""
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
    ...
    def add_task_cards(self):
        """Ajouter les cartes de tâches spécifiques au super administrateur"""
        tasks = [
            {
            ...
            },
            {
                ...
                "icon": "shield-key",
                "description": "Gestion des accès système",
                "status": "Tous les accès OK",
